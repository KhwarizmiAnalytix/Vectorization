"""
Vectorization Build System Helper Modules

Modular helper functions for Scripts/setup.py, split out for readability and
reuse (mirrors the KhwarizmiAnalytix/Logging Scripts/helpers/ package this
standalone Vectorization repo is built alongside).
